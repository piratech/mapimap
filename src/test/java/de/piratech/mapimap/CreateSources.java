...
public class CreateSources {
	...
	private static Source createHTMLAttributePageSource(String base, String url,
			String nameClass, String steetClass, String zipClass, String townClass,
			String addressClass, String urlClass, String lonClass, String latClass,
			String meetingClass, int meetingMatchMode) {
						...
						.asList(new SourceInformationIdentifier<?>[] {
								new SourceInformationIdentifier<AttributeMatcher>(
										...
										new AttributeMatcher("class", nameClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.STREET, "attribute",
										new AttributeMatcher("class", steetClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.ZIP, "attribute",
										new AttributeMatcher("class", zipClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.TOWN, "attribute",
								...
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.URL, "attribute",
										new AttributeMatcher("class", urlClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.LON, "attribute",
										new AttributeMatcher("class", lonClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.ADDRESS, "attribute",
										new AttributeMatcher("class", addressClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.LAT, "attribute",
										new AttributeMatcher("class", latClass,
												AttributeMatcher.EXACT_MATCH)),
								new SourceInformationIdentifier<AttributeMatcher>(
										SourceInformationIdentifierType.MEETING, "attribute",
										new AttributeMatcher("class", meetingClass,
												meetingMatchMode)) }));
		return source;
	}
